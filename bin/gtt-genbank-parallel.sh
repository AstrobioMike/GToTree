...
printf "$assembly\t$1\t$taxid\t$org_name\t$strain\t$num_SCG_hits\t$uniq_SCG_hits\t$perc_comp_rnd\t$perc_redund_rnd\n" >> ${output_dir}/Genbank_genomes_summary_info.tsv
...
rm -rf ${tmp_dir}/${assembly}_genes2.tmp ${tmp_dir}/${assembly}_fasta.tmp ${tmp_dir}/${assembly}_genes1.tmp
rm -rf ${tmp_dir}/${assembly}_genes3.tmp ${tmp_dir}/${assembly}_genes.tmp ${tmp_dir}/${assembly}_curr_hmm_hits.tmp
